...
- [Cómo funciona](docs/COMO_FUNCIONA.es.md) — el sistema completo, con más detalle
- [Resultados reales](docs/RESULTADOS_PRUEBA_REAL.es.md) — una app construida con
  esto, lo que costó y los cuatro defectos que solo aparecieron con uso real
- [Próximas mejoras](docs/PROXIMAS_MEJORAS.es.md) — lo que falta, y lo que se
